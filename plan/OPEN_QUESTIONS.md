...
- [Etapa 2](PLAN-STAGE-2.md): o `sqlglot` no grupo `dev`, que o ensaio de 2026-09-21
  ([`POC.md`](POC.md)) deixou preso ao primeiro statement cujo texto Redshift difira do texto
  DuckDB.
