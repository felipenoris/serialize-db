...
- The user's answers of 2026-09-23 to the pending decisions closed the stage 1 time zone refusal,
  the stage 8 `FILLRECORD`, JSON ceiling and `VARCHAR(n)` width, and the stage 9 runbook place and
  400-day retention; the publication staging, the source of the distribution reading, the
  archived snapshot entry and the pytest temporary folder wait on the user
  (`plan/OPEN_QUESTIONS.md`, `.claude/memory/decisions.md`).
