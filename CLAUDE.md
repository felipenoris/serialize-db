...
- Stages 0, 1 and 2 are closed, and stages 3, 4 and 6 were implemented on 2026-09-23 (`storage`,
  ...
  the target, and the target's root layout becomes `<root>/<environment>/<table>`. Stage 9 has
  no code. The
