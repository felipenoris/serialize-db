...
| `USE` troca o banco da sessão para o do datashare, e `has_schema_privilege` e `svv_table_info` alcançam o esquema depois dele? | `redshift.py`, `RS-19`, `RS-5` e `RS-8` |
